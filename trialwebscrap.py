...
def main():
    ...
    directory = r'C:\Users\91879\OneDrive\Pictures\internship pdf\intern belarc'
    output_file = r'C:\Users\91879\OneDrive\Pictures\output.xlsx'  # Output Excel file
    ...
    headers = ['System Name', 'Department', 'Employee Name', 'Branch Name', 'Location', 'Port Number',
               'Computer Name', 'Operating System', 'System Model', 'Processor', 'Board', 'Hard Disk', 'Memory', 'RAM Slots']
        ...
        if filename.endswith('.html'):
            ...
            if file_info:
                ...
                row = [file_info['System Name'], file_info['Department'], file_info['Employee Name'],
                       ...
                       system_info['Memory'], system_info['RAM Slots']]
                sheet.append(row)
